...
MAP_INDEX: dict[str, int] = {
    "Treehouse": 0,
    "Meadow Zone Main Area": 1,
    "Pokepark Entrance": 2,
    "Meadow Zone Venusaur Area": 3,
    "Beach Zone Main Area": 4,
    "Ice Zone Main Area": 5,
    "Ice Zone Empoleon Area": 6,
    "Cavern Zone Main Area": 7,
    "Magma Zone Main Area": 8,
    "Magma Zone Blaziken Area": 9,
    "Haunted Zone Main Area": 10,
    "Haunted Zone Mansion Area": 11,
    "Haunted Zone Rotom Area": 12,
    "Granite Zone Main Area": 13,
    "Flower Zone Main Area": 14,
    "Skygarden": 15,

    "Bulbasaur's Daring Dash Attraction": 16,
    "Venusaur's Vine Swing Attraction": 17,
    "Pelipper's Circle Circuit Attraction": 18,
    "Gyarados' Aqua Dash Attraction": 19,
    "Empoleon's Snow Slide Attraction": 20,
    "Bastiodon's Panel Crush Attraction": 21,
    "Rhyperior's Bumper Burn Attraction": 22,
    "Blaziken's Boulder Bash Attraction": 23,
    "Tangrowth's Swing-Along Attraction": 24,
    "Dusknoir's Speed Slam Attraction": 25,
    "Rotom's Spooky Shoot-'em-Up Attraction": 26,
    "Absol's Hurdle Bounce Attraction": 27,
    "Salamence's Sky Race Attraction": 28,
    "Rayquaza's Balloon Panic Attraction": 29,
